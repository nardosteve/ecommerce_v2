...
<body>
                ...
                <div class="row">
                    <div class="col-lg-6 col-md-6">
                        <div class="header__top__left">
                            <ul>
                                <li><i class="fa fa-envelope"></i> smungaimuroki@gmail.com</li>
                                <li>Free Shipping for all Order of $99</li>
                            </ul>
                        </div>
                    </div>
    ...
    <div class="container w-50 shadow rounded my-5">
            ...
            <div class="container">
                ...
                <form id="registerForm" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="col-lg-12 col-sm-12 text-center">
                            ...
                            <a class="mx-4" href="./signin.php">Already have an account ? Sign In</a>
                            <!-- Add this hidden input field inside your form -->
                            <!-- <input type="hidden" id="submit" name="submit" value="true"> -->
                            <button type="submit" id="signUpButton" class="site-btn  my-3">Sign Up</button>
                    </div>
                </form>
            </div>
        </div>
    ...
    Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved <i class="fa fa-heart" aria-hidden="true">
    </p></div>
