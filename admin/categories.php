...
<head>
  ...
  <title>Ecommerce - Admin (Categories)</title>
  <!-- plugins:css -->
      ...
      <div class="main-panel">
        <div class="content-wrapper">
          <div class="row">
                ...
                <div class="d-sm-flex flex-row-reverse justify-content-between border-bottom">
                  <div>
                    <div class="btn-wrapper">
                      <a href="#" class="btn btn-success text-white me-0" data-bs-toggle="modal" data-bs-target="#category"><i class="icon-user"></i> Add Category</a>
            ...
            <!-- Modal Popup -->
            <div class="modal fade" id="category" tabindex="-1" aria-labelledby="" aria-hidden="true">
